...
<div>
    ...
    <a href="javascript:cambiarMaterial('t', 'img/echo/3d_color.png')">
        Plantilla
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/echo/mos_azul.png')">
        Mosaico azul
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/echo/madera.png')">
        Madera
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/echo/base1.png')">
...
var textura0 = 'img/echo/3d_gris.png'; // textura que usa el modelo cuando carga la primera vez
