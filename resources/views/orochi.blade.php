...
<div>
    ...
    <a href="javascript:cambiarMaterial('t', 'img/orochi/3d_color.png')">
        Plantilla
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/orochi/mos_azul.png')">
        Mosaico azul
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/orochi/madera.png')">
        Madera
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/orochi/base1.png')">
...
var textura0 = 'img/orochi/3d_gris.png'; // textura que usa el modelo cuando carga la primera vez
        ...
        cambiarMaterial = function(tipo, valor) {
            ...
            switch (tipo) {
                ...
                case 'c': //color solido sin textura
                    ...
                    var textureLoader = new THREE.TextureLoader();
                    var map = textureLoader.load(textura0);
                    var material = new THREE.MeshPhongMaterial({
                        map: map,
                        color: valor,
                        specular: 0x333333,
...
function animate() {
    ...
    // esta línea pone a rotar el modelo automaticamente
...
function agregarLuces() {
    ...
    scene.add( light );
    var light = new THREE.PointLight( colorLuz, 0.7, 100 ); // atras
    light.position.set( 0, 0, -10 );
    scene.add( light );
    var light = new THREE.PointLight( colorLuz, 0.5, 100 ); // arriba adelante
    light.position.set( 0, 10, 10 );
    scene.add( light );
    var light = new THREE.PointLight( colorLuz, 0.5, 100 ); // izquierda
