...
<div>
    ...
    <a href="javascript:cambiarMaterial('t', 'img/mystic/3d_color.png')">
        Plantilla
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/mystic/mos_azul.png')">
        Mosaico azul
    </a> |
    <a href="javascript:cambiarMaterial('t', 'img/mystic/madera.png')">
        Madera
    </a> |
...
var textura0 = 'img/mystic/3d_gris.png'; // textura que usa el modelo cuando carga la primera vez
